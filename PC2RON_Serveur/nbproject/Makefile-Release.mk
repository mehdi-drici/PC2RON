...
${OBJECTDIR}/envoi.o: envoi.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/envoi.o envoi.c
...
${OBJECTDIR}/builder.o: builder.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/builder.o builder.c

${OBJECTDIR}/protocole.o: protocole.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/protocole.o protocole.c
...
${OBJECTDIR}/serveur_nomain.o: ${OBJECTDIR}/serveur.o serveur.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/serveur_nomain.o serveur.c;\
	else  \
...
${OBJECTDIR}/trame_nomain.o: ${OBJECTDIR}/trame.o trame.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/trame_nomain.o trame.c;\
	else  \
...
${OBJECTDIR}/reception_nomain.o: ${OBJECTDIR}/reception.o reception.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/reception_nomain.o reception.c;\
	else  \
...
${OBJECTDIR}/factory_nomain.o: ${OBJECTDIR}/factory.o factory.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/factory_nomain.o factory.c;\
	else  \
...
${OBJECTDIR}/envoi_nomain.o: ${OBJECTDIR}/envoi.o envoi.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/envoi_nomain.o envoi.c;\
	else  \
...
${OBJECTDIR}/joueur_nomain.o: ${OBJECTDIR}/joueur.o joueur.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/joueur_nomain.o joueur.c;\
	else  \
...
${OBJECTDIR}/builder_nomain.o: ${OBJECTDIR}/builder.o builder.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/builder_nomain.o builder.c;\
	else  \
...
${OBJECTDIR}/protocole_nomain.o: ${OBJECTDIR}/protocole.o protocole.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/protocole_nomain.o protocole.c;\
	else  \
